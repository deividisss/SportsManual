...
<input type="file" id="nuotraukaInput" onclick="statai()">
...
<script>
    document.getElementById('nuotrauka').onclick = function () {
        document.getElementById('nuotraukaInput').click();
 ...
 function statai(){
      ...
      var x=document.getElementById("nuotraukaInput").files[0].type
            console.log(x);
 ...
 $(function() {
    ...
    type: "POST",
    url: "updateImage.php",
    data: new FormData($('#input:file')[0]),
     console.log();
    processData: false,
    contentType: false,
