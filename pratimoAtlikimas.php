...
if ($lytisID==1){
  $ulen="select iranga.image_path as irangaFoto,pratimo_pav,irangos_nr,raumuo,priziuretojas,tagai,pratimai.image_path as pratFoto,youtube_nuoroda,
  image2_path as pratFoto2,image3_path as pratFoto3,content_aprasymas,content_atlikimas,raumenys.image_path as raumuoPav
   from pratimai,iranga,raumenys 
   where pratimai.iranga_id=iranga.id and pratimai.raumenys_id=raumenys.id and pratimai.id=$pratId";  
